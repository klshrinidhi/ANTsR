...
img = antsImageRead( system.file( "vignettes/data/KKI2009-01-fMRI.nii" , package = "ANTsR" ) , "float" , 4 )
@
...
library(oro.nifti)
img_oro = readNIfTI( system.file( "vignettes/data/KKI2009-01-fMRI.nii" , package = "ANTsR" ) )
img_oro
descrip( img_oro )
