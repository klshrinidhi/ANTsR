...
int antsRegistration( itk::ants::CommandLineParser *parser )
{
  ...
  for( int currentStage = numberOfStages - 1; currentStage >= 0; currentStage-- )
    ...
    if( std::strcmp( whichMetric.c_str(), "cc" ) == 0 )
      ...
      typedef itk::MattesMutualInformationImageToImageMetricv4<FixedImageType, MovingImageType> MutualInformationMetricType;
    ...
    if( std::strcmp( whichTransform.c_str(), "affine" ) == 0 )
      ...
      typedef itk::ImageRegistrationMethodv4<FixedImageType, MovingImageType, CompositeAffineTransformType> AffineRegistrationType;
      typename AffineRegistrationType::Pointer affineRegistration = AffineRegistrationType::New();
      ...
      typedef itk::ImageRegistrationMethodv4<FixedImageType, MovingImageType, SimilarityTransformType> SimilarityRegistrationType;
...
//      metric->SetDoMovingImagePreWarp( true );
      ...
      typedef itk::SyNImageRegistrationMethod<FixedImageType, MovingImageType, DisplacementFieldTransformType> DisplacementFieldRegistrationType;
